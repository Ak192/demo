...
const Signup = () => {
    return (
        <div className='flex justify-center items-center  bg-slate-500 glass h-[100vh] '>
            <div className='flex  md:w-[75%] lg:w-[68%] mt-16  rounded-lg w-full mx-3 md:mx-0' >
                <div className='bg-[#68717B] w-[40%] md:w-1/2 relative rounded-lg '>
                    ...
                    <img src="Assets/Car.png" alt="" className='absolute w-72 right-[-50px] top-56' />
                </div>
                <div className='md:w-1/2 w-[60%] border bg-white p-5 rounded-lg  '>
                    ...
                    <div className='justify-end  '>
                        ...
                        <form action="">
                        <input type="text" name="name" id="name" placeholder='Full Name' className='border-b-2 w-full  p-4 rounded-md focus:outline-none bg-transparent focus:border-[#797979] ' />
                            ...
                            <input type="password" name="conform-pass" id="conform-pass" placeholder='Re-Password ' className='border-b-2 w-full  p-4 rounded-md focus:outline-none  bg-transparent focus:border-[#797979] ' />
                            <button className='btn btn-outline  w-full  my-4' >Signup Now</button>
                            <p>Already have  an Account? <Link to='/login' className='text-blue-700'>login now</Link></p>
